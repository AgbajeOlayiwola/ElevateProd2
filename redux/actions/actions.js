...
export const loadsetTransactionPin = (code) => (dispatch) => {
    ...
    const cookie = getCookie('cookieToken');
    axiosInstance
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.setTransactionPin}`, code, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const loginUserAction = (loginData) => {
    return (dispatch) => {
        axiosInstance
            .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.login}`, loginData, {
                headers: {
                    credentials: true,
...
export const runVerifyOtp = (otpData) => {
    ...
    return async (dispatch) => {
        await axiosInstance
            .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.verifyOtp}`, otpData, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-Client-Type': 'web',
                    Authorization: `Bearer ${cookie}`
...
export const memartData = (memartdata) => (dispatch) => {
    ...
    // dispatch(accountNumberLoadStart());
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.uploadMemart}`, memartdata, {
            headers: {
                'Content-Type': 'multipart/form-data',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const cacData = (cacdata) => (dispatch) => {
    ...
    // dispatch(accountNumberLoadStart());
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.uploadCacCert}`, cacdata, {
            headers: {
                'Content-Type': 'multipart/form-data',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const scmulData = (scmuldata) => (dispatch) => {
    ...
    // dispatch(accountNumberLoadStart());
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.uploadScmul}`, scmuldata, {
            headers: {
                'Content-Type': 'multipart/form-data',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const forgotPasswordResetData = (data) => (dispatch) => {
    ...
    // dispatch(accountNumberLoadStart());
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.forgotPasswordReset}`, data, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const resetOtpData = (resetOtpdata) => (dispatch) => {
    ...
    // dispatch(accountNumberLoadStart());
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.resetOtp}`, resetOtpdata, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
        ...
        await axios
            ...
            .then((response) => {
                ...
                if (response.data) {
                    ...
                    // dispatch(accountNumberLoadStart());
                    axios
                        .get(`https://mysmeapp.ecobank.com:8443${apiRoutes.verifyCac}`, {
                            headers: {
                                'Content-Type': 'application/json',
                                'X-Client-Type': 'web',
                                Authorization: `Bearer ${cookie}`
...
export const getAddressStatusDetails = () => (dispatch) => {
    ...
    axios
        .get(`https://mysmeapp.ecobank.com:8443${apiRoutes.addressVerification}`, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const getTinDetails = (tinData) => (dispatch) => {
    ...
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.uploadTin}`, tinData, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
                Authorization: `Bearer ${cookie}`
...
export const auth2FaCodeDetails = (auth2FaCodeData) => (dispatch) => {
    ...
    axios
        .post(`https://mysmeapp.ecobank.com:8443${apiRoutes.auth2Fa}`, auth2FaCodeData, {
            headers: {
                'Content-Type': 'application/json',
                'X-Client-Type': 'web',
